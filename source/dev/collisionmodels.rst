...
The relative velocity here is computed as :math:`u=3v_{tr}^2+3v_{ts}^2`. Simpler
formulas for the Coulomb logarithm can be easily generated by developers if necessary.
