-- Gkyl ------------------------------------------------------------------------
-- Plasma beach problem: http://ammar-hakim.org/sj/je/je8/je8-plasmabeach.html
--
-- 5 moment simulation of a wave propagating in a plasma that attenuates
-- (has a decreasing density) with x.
--------------------------------------------------------------------------------
...
momentApp = Moments.App {
   ...
   emSource = Moments.CollisionlessEmSource {
      ...
      -- Not enabled here; for demo purposes.
      -- Note: Dp are c arrays and use 0-based indices; xc and qbym are
      --       Lua arrays and use 1-based indices.
